...
namespace alphappy.TAMacro
{
    internal class Settings : OptionInterface
    {
        ...
        public static Configurable<KeyCode> kbOpenFolder = instance.config.Bind("kbOpenFolder", KeyCode.None, new ConfigurableInfo("Open folder in Explorer"));
        ...
        public static Configurable<KeyCode>[] allNonselectorKeys = { kbPrevPage, kbInterrupt, kbNextPage, kbUpOne, kbReloadLibrary, kbToggleRecording, kbToggleVisible, kbOpenFolder };
